...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <h3><a href="https://2kuaiqian.taobao.com/">4：更多精品源码下载</a></h3>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <h3><a href="<?php echo U('usermoneylogs/index');?>">6：还有<a class="red"><?php echo round($counts['community_order']/100,2);?></a>元物业费未缴</a></h3>
            </div>
    </div>
</div>
</li>
