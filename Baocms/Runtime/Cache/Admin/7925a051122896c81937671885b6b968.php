    ...
    <body>
        ...
        <div class="top">
            ...
            <div class="center">
                ...
                <div class="t3">
                <ul>
                	 <!--<li><a class="jq_menu"  target="main_frm" href="<?php echo U('clean/cache');?>">待处理（<p class="hongse">2</p>）</a></ul>li>-->
               
                    <!-- <li><a class="jq_menu" target="_blank" href="https://2kuaiqian.taobao.com/">升级动态</a></li>-->
