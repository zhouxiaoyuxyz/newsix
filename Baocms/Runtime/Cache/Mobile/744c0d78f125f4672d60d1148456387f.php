...
<header class="top-fixed bg-yellow bg-inverse">
    ...
    <?php if(empty($keyword)): ?><div class="top-title">今日单 次日达</div><?php endif; ?>
...
<body>
<div class="demo">
    <img src="https://www.enjoysix.cn/11.png"/>
</div>
...
<!----><?php if(empty($cat) && empty($business_id) && empty($order) && empty($keyword)): ?><ul class="cate-wrap bbOnepx" style="margin-bottom: 0">
        ...
        <li>
            <a class="icon2" href="<?php echo U('tuan/index',array('cat'=>3));?>" tongji_tag="m_home_sale_new">
                <span class="cate-img" id="sale"><img src="/static/default/wap/image/tuan/tuan_cate_4.png" /></span>
                <span class="cate-desc">酒水</span>
            </a>
        </li>
        <li>
        ...
        <li>
            <a class="icon2" href="<?php echo U('tuan/index',array('cat'=>33));?>" tongji_tag="m_home_bendishenghuo_new">
                <span class="cate-img" id="shenghuo"><img src="/static/default/wap/image/tuan/tuan_cate_8.png" /></span>
                <span class="cate-desc">乡愁</span>
            </a>
        </li>
