...
<link rel="stylesheet" href="/static/default/wap/css/shop.css">
    ...
    <div class="inner" style=" display:none">
        <ul>
          <li class="on"><a <?php if(empty($cat)): ?>on<?php endif; ?> href="<?php echo LinkTo('huodong/index',$linkArr,array('cat'=>0));?>" >全部分类</a></li>
                <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li <?php if($item['cate_id'] == $cat): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('cat'=>$item['cate_id']));?>"><?php echo ($item["cate_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="inner" style="display:none;">
              <ul>
                ...
                <li <?php if(empty($bg_time)): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>0));?>">全部</a></li>
                <li <?php if($bg_time == 1): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>1));?>">今天</a></li>
                <li <?php if($bg_time == 2): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>2));?>">昨天</a></li>
                <li <?php if($bg_time == 3): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>3));?>">一周内</a></li>
                <li <?php if($bg_time == 4): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>4));?>">一月内</a></li>
                <li <?php if($bg_time == 5): ?>style="color:red;"<?php endif; ?> ><a href="<?php echo LinkTo('huodong/index',$linkArr,array('bg_time'=>5));?>">一月前</a></li>
...
<i class="pull2"></i>
	...
	<script>
		$(document).ready(function () {
			...
			loaddata('<?php echo ($nextpage); ?>', $("#item-list"), true);
		});
	</script>
