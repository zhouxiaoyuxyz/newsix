...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php $city_ids = D('City') -> where('city_id ='.$admin['city_id']) -> find(); $city = $city_ids['name']; ?>
        ...
        <title>物业<?php echo ($CONFIG["site"]["title"]); ?>管理后台</title>
        <meta name="description" content="物业<?php echo ($CONFIG["site"]["title"]); ?>管理后台" />
        <meta name="keywords" content="物业<?php echo ($CONFIG["site"]["title"]); ?>管理后台" />
    ...
    <body>
        ...
        <div class="top">
            ...
            <div class="center">
                ...
                <div class="t3">
                <ul> 
                     <li><a class="jq_menu" target="_blank" href="#">物业版本号：V1.0</a></li>
        ...
        <div class="bottom_box">
            <div class="leftMenu">
              ...
              <div class="info">
                ...
                <img src="__TMPL__statics/images/state_online.png" alt="Status"> <span></span>
