...
<html lang="zh-cn">
    ...
    <a class="foot-item <?php if(($ctl == 'index') AND ($act != 'more')): ?>active<?php endif; ?>" href="<?php echo U('index/index');?>">		
    	<span class="icon icon-home"></span>		
            ...
            <a class="foot-item <?php if(($ctl) == "news"): ?>active<?php endif; ?>" href="<?php echo U('news/index');?>">		
            	<span class="icon icon-bullhorn"></span>			
                <span class="foot-label">通知</span>		</a>		
            
            <a class="foot-item <?php if(($ctl) == "feedback"): ?>active<?php endif; ?>" href="<?php echo U('feedback/index');?>">			
            <span class="icon icon-gears"></span>			
            <span class="foot-label">报修</span>		</a>	
            
              <a class="foot-item <?php if(($act) == "order"): ?>active<?php endif; ?>" href="<?php echo U('index/order');?>">			
            <span class="icon icon-calendar"></span>			
            <span class="foot-label">账单</span>		</a>
            
             <!-- <a class="foot-item <?php if(($ctl) == "bbs"): ?>active<?php endif; ?>" href="<?php echo U('bbs/index');?>">			
            <span class="icon icon-commenting-o"></span>			
            <span class="foot-label">贴吧</span>		</a>	-->
