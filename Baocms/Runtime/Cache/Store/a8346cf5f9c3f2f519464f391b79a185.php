...
<div class="container">
		<div class="line detail-base">
			<div class="x5">
				<div class="pic">
					<a href="#"><img src="<?php echo config_img($SHOP['logo']);?>"></a>	
			...
			<div class="x7">
                ...
                <p>员工：<?php echo ($counts['shopworker']); ?>人 &nbsp;<a href="<?php echo u('worker/index');?>">管理</a></p>
			</div>
		</div>
       </div>
...
<div class="panel-list">
	<ul>
        <li>
            <a href="<?php echo U('shop/about');?>">
                <span class="icon-gears "></span>
                商户设置
                <?php if($shop_branch > 0): ?><font>
                        <?php echo ($shop_branch); ?>家分店<?php if($shop_branch_audit > 0): ?>，待审核<b><?php echo ($shop_branch_audit); ?></b>家。<?php endif; ?>
                    </font><?php endif; ?>
            ...
            <li>
                <a href="<?php echo U('tuan/order');?>"><span class="icon-tags"></span>
                    抢购
                    <font>
                        <?php if($counts['tuan_order_code_is_used'] > 0): ?>待验<?php echo ($counts['tuan_order_code_is_used']); ?>单<?php endif; ?>
                        <?php if($counts['tuan_order_code_is_used_ture'] > 0): ?>，已验<?php echo ($counts['tuan_order_code_is_used_ture']); ?>单<?php endif; ?>
                        <?php if($counts['tuan'] > 0): ?>，抢购<?php echo ($counts['tuan']); ?>单<?php endif; ?>
                        <?php if($counts['tuan_audit'] > 0): ?>，待审<b><?php echo ($counts['tuan_audit']); ?></b>单<?php endif; ?>
                    </font>
                    <i class="icon-angle-right"></i>
                </a>
            </li>
        
        <?php if(!empty($SHOPGRADE['is_coupon'])): ?><li>
            ...
            <?php if(!empty($SHOPGRADE['is_mall'])): ?><li>
                    <a href="<?php echo U('mart/index');?>"><span class="icon-home"></span>商城管理
                    <font>
        ...
        <li>
            <a href="<?php echo U('fans/index');?>"><span class="icon-group"></span>粉丝
                <font>
        ...
        <?php if(!empty($SHOPGRADE['is_ele'])): ?><li>
                <a href="<?php echo U('ele/eleorder',array('status'=>1));?>"><span class="icon-home"></span>外卖
                <font>
            ...
            <?php if(!empty($SHOPGRADE['is_life'])): ?><li>
                    <a href="<?php echo U('life/index');?>"><span class="icon-truck"></span>同城信息
                    <font>
        ...
        <!--<li>
            <a href="<?php echo U('nearwork/index');?>"><span class="icon-github"></span>人才招聘
                <font>
        ...
        <li>
            <a href="<?php echo U('yuyue/index');?>"><span class="icon-phone-square"></span>预约管理
                <font>
        ...
        <li><a href="<?php echo U('money/index');?>"><span class="icon-btc"></span>财务<i class="icon-angle-right"></i></a></li>
