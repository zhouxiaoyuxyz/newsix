...
<style>
ul{ padding-left:0px;}
.list-media-x p { font-weight: normal;}
.top-fixed .top-title {padding:0;margin-top: -2px;}
.button-toolbar .button-group a{background: none;color: #FFF;}
.button-toolbar .button-group a.active{background: #fff;color: #06C1AE;}
</style>
<header class="top-fixed bg-yellow bg-inverse">
	...
	<div class="button-toolbar">
		<div class="button-group">
			...
			<a class="block button active" href="<?php echo LinkTo('tuan/index',array('aready'=>0));?>">订单</a>
		    <a class="block button" href="<?php echo LinkTo('tuancode/index');?>">取货劵</a>
		</div>
...
<ul id="shangjia_tab">
        <li style="width:20%;"><a href="<?php echo LinkTo('tuan/index',array('aready'=>0));?>" <?php if(($aready) == "0"): ?>class="on"<?php endif; ?>>待付款</a></li>
        <li style="width:20%;"><a href="<?php echo LinkTo('tuan/index',array('aready'=>-1));?>" <?php if(($aready) == "-1"): ?>class="on"<?php endif; ?>>到店付</a></li>
        <li style="width:20%;"><a href="<?php echo LinkTo('tuan/index',array('aready'=>1));?>" <?php if(($aready) == "1"): ?>class="on"<?php endif; ?>>已付款</a></li>
        <li style="width:20%;"><a href="<?php echo LinkTo('tuan/index',array('aready'=>3));?>" <?php if(($aready) == "3"): ?>class="on"<?php endif; ?>>待退款</a></li>
        <li style="width:20%;"><a href="<?php echo LinkTo('tuan/index',array('aready'=>4));?>" <?php if(($aready) == "4"): ?>class="on"<?php endif; ?>>已退款</a></li>
...
<script>
	$(document).ready(function () {
		loaddata('<?php echo U("mcenter/tuan/orderloading/",array("aready"=>$aready,"p"=>"0000"));?>', $("#list-media ul"), true);
	});
</script>
