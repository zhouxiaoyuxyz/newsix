...
<ul id="shangjia_tab">
	<li class="x3"><a href="<?php echo u('logs/moneylogs');?>">余额日志</a></li>
	<li class="x3"><a href="<?php echo u('logs/wy_fanxianlogs');?>" class="on" >生活费日志</a></li>
	<li class="x3"><a href="<?php echo u('logs/integral');?>">积分日志</a></li>
	<li class="x3"><a href="<?php echo u('logs/rechargecard');?>">代金券日志</a></li>
</ul><!---->
...
<script>
	$(document).ready(function(){        
		loaddata('<?php echo U("logs/wy_fanxian_data",array("p"=>"0000"));?>',  $("#list-media ul"),true);
	});
</script>
