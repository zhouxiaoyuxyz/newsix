...
class WeixintmplModel extends CommonModel{
    ...
    public function weixin_notice_bonus_user($user_id,$bonusID,$type){
            ...
            $notice_data = array(
				...
				'first' => '腊八红包大派送!', 
				'remark' => '腊八节现金红包，不定时推送，先到先得，邀请邻里赚到手软^^^详情登录-https://' . $_SERVER['HTTP_HOST'], 
				 
				'prize' => '转发内页可让让身边朋友陪你一起抢红包，会员中心-生成海报:邀请邻里使用易社区赚取丰厚佣金', 
      ...
      //print $channelId;
            ...
            try {
                $response = $client->push()
                    ...
                    ->setNotificationAlert("易社区收款:".$order_price1)
                    ->androidNotification("易社区收款:".$order_price1, array(
                        'title' => '收款通知!',
                        'builder_id' => 2,
...
//                        ),
                    ...
                    ->message("易社区收款:".$order_price1, array(
                        'title' => '收款通知!',
                        // 'content_type' => 'text',
//                        'extras' => array(
//                            'key' => 'value',
