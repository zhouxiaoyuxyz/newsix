...
class WeixintmplModel extends CommonModel{
    ...
    public function weixin_pay_balance_shop($log_id,$type){
           ...
           $_data_order_notice = array(
			...
			include_once "AipSpeech.php";
			// 你的 APPID AK SK
			const APP_ID = '10232530';
			const API_KEY = '5muVmlgnEE8Fhw5GwsusHGBL’；
			const SECRET_KEY = '9ac8a26347c1d2b31dbeb8bdf79270ae';
...
// 识别正确返回语音二进制 错误则返回json 参照下面错误码
        if(!is_array($result)){
         	...
         	echo '<embed height="0" width="0" src="audio.mp3" />';  
        }
		return true;
	}
