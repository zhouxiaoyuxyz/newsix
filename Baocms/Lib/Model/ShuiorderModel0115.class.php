...
class ShuiorderModel extends CommonModel
{
    ...
    public function settlement($order_id)
    {
        ...
        //写入商户资金日志
        D('Shopmoney')->add(array('shop_id' => $order['shop_id'], 'city_id' => $shop['city_id'], 'area_id' => $shop['area_id'], 'branch_id' => $data['branch_id'], 'money' => $money*100, 'type' => 'shui', 'order_id' => $logs['order_id'], 'create_time' => NOW_TIME, 'create_ip' => $ip, 'intro' => $intro));
