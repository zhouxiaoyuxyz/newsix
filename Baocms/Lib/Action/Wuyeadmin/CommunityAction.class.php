...
class CommunityAction extends CommonAction {
    ...
    private $create_fields = array('name', 'addr', 'tel', 'pic','uid','user_id','city_id', 'area_id', 'village_id','property', 'lng', 'lat', 'orderby');
    private $edit_fields =   array('name', 'addr', 'tel', 'pic','uid','user_id','city_id', 'area_id','village_id', 'property', 'lng', 'lat', 'orderby');
    ...
    public function index() {
        ...
        $map = array('uid'=>$this->_admin['admin_id']);
