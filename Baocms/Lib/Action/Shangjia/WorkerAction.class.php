...
class WorkerAction extends CommonAction {
	...
	private $edit_fields = array('user_id', 'name', 'tel', 'mobile', 'qq', 'weixin', 'work', 'city_id', 'area_id', 'business_id', 'addr', 'tuan', 'coupon', 'yuyue', 'is_job','is_mall', 'is_ding', 'is_dianping', 'is_yuyue','is_life','is_news');
