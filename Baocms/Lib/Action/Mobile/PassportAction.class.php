<?php
//wap蜂蜜源码2016年4月21日二次开发，qq120585022
class PassportAction extends CommonAction
{
    ...
    public function newpwd()
    {
        ...
        if ($way == 1) {
            ...
            D('Passport')->uppwd($user['account'], '', $password);
            if ($this->_CONFIG['sms']['dxapi'] == 'dy') {
                D('Sms')->DySms($this->_CONFIG['site']['sitename'], 'sms_user_newpwd', $mobile, array('sitename' => $this->_CONFIG['site']['sitename'], 'newpwd' => $password));
            } else {
