...
class ShopAction extends CommonAction{
    ...
    public function breaks($shop_id){
        ...
        if ($this->isPost()) {
            ...
            $data = array('shop_id' => $shop_id, 'user_id' => $this->uid, 'amount' => $amount, 'exception' => $exception, 'use_money' => $use_money, 'fx_money' => $fx_money, 'need_pay' => $need_pay, 'create_time' => NOW_TIME, 'create_ip' => get_client_ip());
