...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title','intro','guige', 'num','shop_id', 'photo', 'cate_id', 'price', 'mall_price','is_agent_price','cost_price','factory_price','wholesale_price','agent_price','market_price','retail_price','gross_margin','profit_margin','settlement_price','return_cash','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','is_vs1','is_vs2','is_vs3','is_vs4','is_vs5',
    ...
    private function createCheck() {
		...
		$data['return_cash'] = (int) ($data['return_cash'] * 100);
