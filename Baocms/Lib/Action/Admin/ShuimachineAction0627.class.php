...
class ShuimachineAction extends CommonAction{
    private $create_fields = array('m_sn', 'city_id', 'area_id', 'model', 'price', 'fanxian','wy_fanxian', 'command', 'pic', 'admin_id', 'lng', 'lat', 'orderby','create_time');
    private $edit_fields = array('m_sn', 'city_id', 'area_id', 'model', 'price', 'fanxian', 'wy_fanxian', 'command', 'pic', 'admin_id', 'lng', 'lat', 'orderby');
    ...
    private function editCheck(){
		...
		if ($data['fanxian']+$data['wy_fanxian']>=$data['price']) {
