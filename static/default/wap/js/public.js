...
function check_ext_mobile(url1,url2){
	layer.open({
		type: 1,
		title:'<h4>请绑定副卡用于线下消费</h4>',
		skin: 'layui-layer-molv', //加上边框
		area: ['90%', '300px'], //宽高
		shift:6,
		content: '<div class="form-auto form-x"><div class="form-group"><div class="label"><label>手机号</label></div><div class="field form-inline"><input class="input input-auto" name="ext_mobile" id="ext_mobile" value="" placeholder="填写手机号码" size="20" type="text"> <button class="button margin-top bg-yellow" id="jq_send">获取验证码</button></div></div><div class="form-group"><div class="label" ><label>验证码</label></div><div class="field"><input class="input input-auto" name="yzm" id="yzm" value="" size="10" placeholder="填写验证码" type="text"></div></div><div class="form-button"><button id="go_mobile" class="button bg-yellow edit_post" type="submit">立刻认证</button></div></div>'
	});
	//获取验证码
	var mobile_timeout;
	var mobile_count = 100;
...
function change_ext_mobile(url1,url2){
	layer.open({
		type: 1,
		title:'请绑定副卡用于线下消费',
		skin: 'layer-ext-demo', //加上边框
		area: ['90%', '280px'], //宽高
		content: '<div class="padding-big">手机号<br /><input name="ext_mobile" id="ext_mobile" type="text" size="13" class="input input-auto" /> <button class="button bg-yellow edit_post" type="button" id="jq_send">获取验证码</button><br /><div class="blank-10"></div>验证码<br /><input  class="input input-auto" size="10"  name="yzm" id="yzm" type="text" /> 输入验证码<br><div class="blank-20"></div><input type="submit" value="立刻认证" class="button bg-yellow edit_post"  id="go_mobile" /></div>'
	});
	//获取验证码
	var mobile_timeout;
	var mobile_count = 100;
